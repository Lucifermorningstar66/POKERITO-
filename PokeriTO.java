...
public class PokeriTO {
 ...
 public static void main(String[] args) {
    Scanner scan = new Scanner(System.in);
         ...
         String systemCard = randomCard();

         System.out.println("Here Is Your Card My Friend:: ");
         System.out.println(playerCard);
         System.out.println("Here Is Computer's Card:: ");
         System.out.println(systemCard);
         ...
         System.out.println("Computer score is " + systemScore);

         if(playerScore > systemScore)
         {
            System.out.println("HAZA MY FRIREND...YOU WiN :)");
         }
         else if(playerScore < systemScore)
         {
            System.out.println("AH SHIT...YOU LOSE :|");
         }
         else if(playerScore == systemScore)
         {
            System.out.println("HEY everyone WIN...:)");
         }
